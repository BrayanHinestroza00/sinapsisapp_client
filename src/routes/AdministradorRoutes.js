...
function AdministradorRoutes() {
  return (
    <Routes>
      ...
      <Route exact path="/Emprendedores/:idEmprendedor" element={<></>} />
      ...
      />
      <Route exact path="/Gestion/Mentores" element={<GestionMentoresPage />} />
      <Route exact path="/Gestion/Anuncios" element={<GestionAnunciosPage />} />
