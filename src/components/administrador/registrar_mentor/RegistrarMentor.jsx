...
import { validacionesSignUpMentor } from "src/utils/validaciones";
...
function RegistrarMentor({ show, onHide }) {
  ...
  const onHandleSubmit = (e) => {
    ...
    if (Object.keys(erroresFormulario).length) {
      ...
      setError({});
      confirmAlert({
        title: "¿Estás seguro que deseas registar el mentor en SINAPSIS UAO?",
            ...
            {tiposDocumentoLoading || etapasRutaLoading ? (
              ...
              <>
                <p className="text-muted text-center">
                  ...
                  <br />
                  <span>
                    Utilizamos su usuario institucional para el registro.
                  </span>
                  <br />
                  <span>
